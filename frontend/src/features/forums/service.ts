...
import { ForumResponse, MessageResponse, QuestionResponse, MessageType } from './types';
...
export const forumService = {
  ...
  getMessages: (eventId: string, page = 0, size = 50) => 
    api.get<PageResponse<MessageResponse>>(`/events/${eventId}/forum/messages`, { params: { page, size } }),
  ...
  getQuestions: (eventId: string, page = 0, size = 50) =>
    api.get<PageResponse<QuestionResponse>>(`/events/${eventId}/forum/questions`, { params: { page, size } }),
};